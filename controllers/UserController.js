...
module.exports = {
    ...
    editPassword(req,res,next){
        ...
        if (body.newPassword != null || body.newPassword != undefined){
            ...
            User.findOneAndUpdate({"_id" : token.userId},{ "fullname": body.fullname, "address": body.address, "postalcode": body.postalcode, "city": body.city, "country": body.country })
                .then((newUser) => {
                    res.status(200).json({
                        "message": "User has been succesfully edited.",
                        "code": 200,
                        "user": newUser
                    })
                })
